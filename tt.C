...
void about(void)
{
   ...
   window(15,5,80,25);
   textcolor(LIGHTRED);
   cprintf("\n A B O U T   T Y P I N G   T E S T E R\n This program was made by and is copyright of Devarghya Debroy of SY COMP, COEP. I was inspired to make this by typeracer.com where we had to do our first assignment of this semester. Tested in Windows and Ubuntu, but requires conio.h to be installed for the latter");
